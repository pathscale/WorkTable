...
pub mod prelude {
    ...
    pub use crate::{
        ArcticIndex, ArcticKey, AvailableIndex, ClusteredColumnarIndex, ColumnCompression, ColumnRowId, ColumnarColumn,
        CongeeIndex, CongeeKey, Difference, IndexError, IndexMap, IndexMultiMap, MultiPairRecreate,
        PersistentArcticIndex, PersistentArtIndex, PersistentCongeeIndex, PersistentWtiIndex, PrimaryIndex, TableIndex,
