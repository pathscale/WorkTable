...
impl Generator {
    ...
    pub fn gen_table_select_result_executor_impl2(&self) -> TokenStream {
        let name_generator = WorktableNameGenerator::from_table_name(self.name.to_string());
        let row_type = name_generator.get_row_type_ident();
        ...
        quote! {
            ...
            impl<I> SelectQueryExecutor2<#row_type, I, #column_range_type>
                for SelectQueryBuilder2<#row_type, I, #column_range_type>
            where
                I: Iterator<Item = #row_type>,
            {
                fn execute2(self) -> Result<Vec<#row_type>, WorkTableError> {
