...
use data_bucket::{INNER_PAGE_SIZE, IndexPage, parse_page};
...
async fn test_index_page_read_in_space() {
    ...
    let page = parse_page::<IndexPage<u64>, { INNER_PAGE_SIZE as u32 }, DEFAULT_PAGE_STRIDE>(&mut file, 2)
        .await
        .unwrap();
...
async fn test_index_page_read_after_create_node_in_space_index() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_create_node.wt.idx")
        .await
        .unwrap();

    let page = parse_page::<IndexPage<u32>, { INNER_PAGE_SIZE as u32 }, DEFAULT_PAGE_STRIDE>(&mut file, 2)
        .await
        .unwrap();
...
async fn test_index_page_read_after_insert_at_in_space_index() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_insert_at.wt.idx")
        .await
        .unwrap();
...
async fn test_index_page_read_after_insert_at_with_node_id_update_in_space_index() {
    let mut file =
        worktable::prelude::fsx::open("tests/data/expected/space_index/process_insert_at_with_node_id_update.wt.idx")
            .await
            .unwrap();
...
async fn test_index_page_read_after_remove_at_node_id_in_space_index() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_remove_at_node_id.wt.idx")
        .await
        .unwrap();
...
async fn test_index_page_read_after_remove_at_in_space_index() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_remove_at.wt.idx")
        .await
        .unwrap();
...
async fn test_index_page_read_after_insert_at_removed_place_in_space_index() {
    let mut file =
        worktable::prelude::fsx::open("tests/data/expected/space_index/process_insert_at_removed_place.wt.idx")
            .await
            .unwrap();
...
async fn test_index_pages_read_after_creation_of_second_node_in_space_index() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_create_second_node.wt.idx")
        .await
        .unwrap();
    ...
    let page = parse_page::<IndexPage<u32>, { INNER_PAGE_SIZE as u32 }, DEFAULT_PAGE_STRIDE>(&mut file, 3)
        .await
        .unwrap();
...
async fn test_index_pages_read_after_creation_of_node_after_remove_node_in_space_index() {
    let mut file =
        worktable::prelude::fsx::open("tests/data/expected/space_index/process_create_node_after_remove.wt.idx")
            .await
            .unwrap();
...
async fn test_index_pages_read_full_page() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_insert_at_big_amount.wt.idx")
        .await
        .unwrap();
...
async fn test_index_pages_read_after_node_split() {
    let mut file = worktable::prelude::fsx::open("tests/data/expected/space_index/process_split_node.wt.idx")
        .await
        .unwrap();
