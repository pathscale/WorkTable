...
#[test]
fn test_index_table_of_contents_read_from_space_index_after_insert() {
    let mut file = OpenOptions::new()
        .write(true)
        .read(true)
...
#[test]
fn test_index_table_of_contents_read_from_space_index_with_remove_at_node_id() {
    let mut file = OpenOptions::new()
        .write(true)
        .read(true)
...
#[test]
fn test_index_table_of_contents_read_from_space_index_after_split_node() {
    let mut file = OpenOptions::new()
        .write(true)
        .read(true)
