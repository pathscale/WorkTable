...
pub struct Queries {
    pub update_partials: IndexMap<Ident, Operation>,
    pub deletes: IndexMap<Ident, Operation>,
    pub update_partials_in_place: IndexMap<Ident, Operation>,
    /// The profile named by `update_partial runtime <profile>:`, when the section was
    ...
    pub update_partial_runtime: Option<Ident>,
    /// The profile named by `delete runtime <profile>:`. See `update_partial_runtime`.
    pub delete_runtime: Option<Ident>,
    /// The profile named by `update_partial_in_place runtime <profile>:`. See
    /// `update_partial_runtime`.
    pub update_partial_in_place_runtime: Option<Ident>,
}
